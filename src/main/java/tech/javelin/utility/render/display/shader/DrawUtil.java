...
import tech.javelin.utility.interfaces.IWindow;
...
import tech.javelin.utility.render.display.base.CustomSprite;
...
public final class DrawUtil implements IWindow {
   ...
   public static void initializeShaders() {
      rectangleProgram = new GlProgram(Javelin.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      squircleProgram = new GlProgram(Javelin.id("squircle/data"), VertexFormats.POSITION_COLOR);
      squircleTextureProgram = new GlProgram(Javelin.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      roundedTextureProgram = new GlProgram(Javelin.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      borderProgram = new GlProgram(Javelin.id("border/data"), VertexFormats.POSITION_COLOR);
      figmaBorderProgram = new GlProgram(Javelin.id("corner/data"), VertexFormats.POSITION_COLOR);
      loadingProgram = new GlProgram(Javelin.id("loading/data"), VertexFormats.POSITION_COLOR);
      gradientRectangleProgram = new GlProgram(Javelin.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
      blurProgram = new GlProgram(Javelin.id("blur/data"), VertexFormats.POSITION_COLOR);
      metaballsProgram = new GlProgram(Javelin.id("metanoise/data"), VertexFormats.POSITION_COLOR);
   }
   ...
   public static void drawGlow(MatrixStack matrixStack, float x, float y, float width, float height, int glowRadius) {
      Render2DUtil.drawGradientBlurredShadow(matrixStack, x, y, width, height, glowRadius, Gradient.of(Javelin.getInstance().getThemeManager().getCurrentTheme().getColor(), Javelin.getInstance().getThemeManager().getCurrentTheme().getColor(), Javelin.getInstance().getThemeManager().getCurrentTheme().getSecondColor(), Javelin.getInstance().getThemeManager().getCurrentTheme().getSecondColor()));
   }
